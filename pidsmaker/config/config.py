...
FEATURIZATIONS_CFG = {
    ...
    "flash": {
        "min_count": Arg(int),
        "workers": Arg(int),
        "adapt_codebert": Arg(bool),
        "target_loss": Arg(float),
        "min_steps_before_stop": Arg(int),
        "codebert_model_name": Arg(str),
        "mlm_probability": Arg(float),
        "mlm_batch_size": Arg(int),
        "mlm_learning_rate": Arg(float),
        "max_length": Arg(int),
        "sample_fraction": Arg(float),
    },
    "argus": {
        "min_count": Arg(int),
        "workers": Arg(int),
        ...
        "max_length": Arg(int),
        "sample_fraction": Arg(float),
        "projection_train_epochs": Arg(int),
        "projection_batch_size": Arg(int),
        "projection_learning_rate": Arg(float),
    },
